...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "c2fb2a62-0249-4bf2-8fac-cf57879039d4",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "9e9d2de3-dc1f-4ec8-9562-0f6882303a77",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("fjorubordid_database.Models.OrderItem", b =>
                {
                    b.HasOne("fjorubordid_database.Models.Drink", "Drink")
                        .WithMany()
                        .HasForeignKey("DrinkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("fjorubordid_database.Models.Food", "Food")
                        .WithOne("OrderItem")
                        .HasForeignKey("fjorubordid_database.Models.OrderItem", "FoodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
